...
two different images, use a mask-filter to define the overlapping behaviour they should have, and then collapse the overlapping image pyramids.
...
\caption{The conjoining of the images at multiple resolution levels with the help of a mask.}
\label{fig:lap3}
\end{figure}
...
dummy as a mask. This gave some rather good results, but with a bit blurred out edges along the person (see figure \ref{1} and \ref{2}).
